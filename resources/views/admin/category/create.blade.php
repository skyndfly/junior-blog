...
@section('content')
    ...
    <form action="" class="bg-white p-4 flex flex-col gap-4 rounded-md" >
        ...
        <div class=" grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div class="sm:col-span-4">
                <label for="parent_id" class="block text-sm font-medium leading-6 text-gray-900">Родительская
                    категория</label>
                <div class="mt-2">
                    <div
                        class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">

                        <select name="parent_id" id="parent_id" class="block flex-1 border-0 bg-transparent py-1.5 pl-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6">
