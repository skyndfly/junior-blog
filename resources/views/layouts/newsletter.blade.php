<div class="relative isolate overflow-hidden bg-purple-950 py-16 sm:py-24 lg:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
            <div class="max-w-xl lg:max-w-lg">
                <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">Подписывайтесь на рассылку</h2>
                <p class="mt-4 text-lg leading-8 text-gray-300">*в разработке</p>
